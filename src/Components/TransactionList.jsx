...
export default function TransactionList() {
  ...
  if (allTransactions.length <= 0 && fetchingTransError)
    return <div className={styles.error}>{fetchingTransError ? "Check your connection and try again." : ""}</div>;
  return (
                  ...
                  (
                    ...
                    return (
                      <tr
                        ...
                        key={index}
                        onClick={() => handleTransactionDetail(id, transaction_status, transaction_title)}
                      >
